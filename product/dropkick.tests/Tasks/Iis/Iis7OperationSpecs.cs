namespace dropkick.tests.Tasks.Iis
{
    ...
    public class Iis7OperationSpecs
    {
        #region Nested type: Iis7OperationsSpecsBase

        public abstract class Iis7OperationsSpecsBase : TinySpec
        {
            protected Iis7OperationTask task;
        ...
        public class When_stopping_a_running_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
        ...
        [Category("Integration")]
        public class When_stopping_a_stopped_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
        ...
        [Category("Integration")]
        public class When_stopping_a_non_existant_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
        ...
        [Category("Integration")]
        public class When_starting_a_stopped_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
        ...
        [Category("Integration")]
        public class When_starting_a_running_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
        ...
        [Category("Integration")]
        public class When_starting_a_non_existant_application_pool : Iis7OperationsSpecsBase
        {
            public override void Context()
            {
                base.Context();
