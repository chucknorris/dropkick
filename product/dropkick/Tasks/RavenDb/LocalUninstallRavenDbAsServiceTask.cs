...
namespace dropkick.Tasks.RavenDb
{
    ...
    public class LocalUninstallRavenDbAsServiceTask : BaseTask
    {
        ...
        {
            get { return "Uninstalling local RavenDb as a service from location {0}.".FormatWith(_location); }
        }
        ...
        public override DeploymentResult Execute()
        {
            ...
            result.AddGood("Uninstalled local RavenDb as a service from location {0}.", _location);
