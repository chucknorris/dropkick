...
namespace dropkick.Tasks.NServiceBusHost
{
    ...
    public class LocalNServiceBusHostInstallTask : BaseTask
    {
        private readonly LocalCommandLineTask _task;
        private readonly PromptService _prompt = new ConsolePromptService();

        public LocalNServiceBusHostInstallTask(string exeName, string location, string instanceName, string username, string password, string serviceName, string displayName, string description, string profiles)
        {
