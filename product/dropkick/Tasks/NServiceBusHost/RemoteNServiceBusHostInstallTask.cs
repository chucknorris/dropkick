...
namespace dropkick.Tasks.NServiceBusHost
{
    ...
    public class RemoteNServiceBusHostInstallTask :
        BaseTask
    {
        readonly RemoteCommandLineTask _task;
        readonly PromptService _prompt = new ConsolePromptService();

        public RemoteNServiceBusHostInstallTask(string exeName, string location, string instanceName, PhysicalServer site, string username, string password, string serviceName, string displayName, string description, string profiles)
        {
